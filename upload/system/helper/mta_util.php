...
function mta_aff_link_script($code) {
	...
	$(document).ready(function() {
		$("footer>.container>.row").prepend(\'<div class="alert alert-info"><div class="text-right" style="display:none;padding-bottom:3px;color:#c43;">\'+document.location.href + (document.location.href.indexOf(\'?\') == -1 ? \'?\' : \'&amp;\') + \'tracking=' . $code . ' &nbsp; </div><a href="javascript:;" onclick="javascript:$(this).parent().find(\\\'div\\\').toggle();"><img src="catalog/view/theme/default/image/link.png" /></a></div>\');		
	});
	</script>
	';
}
