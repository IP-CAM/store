...
$_['help_dcc_settle']				 = 'If your sub-account is DCC enabled you must use Autosettle';
...
$_['error_use_select_card']			 = 'You must have "Select Card" enabled for sub-account routing by card type to work';