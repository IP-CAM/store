...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.70139998, 1, '2016-01-17 11:28:44'),
(2, 'US Dollar', 'USD', '$USD  ', '', '2', 1.00000000, 1, '2016-01-17 14:30:00'),
(3, 'Euro', 'EUR', '', '€', '2', 0.91640002, 1, '2016-01-17 11:28:44'),
(4, 'Canadian Dollar', 'CAD', '$CAD ', '', '2', 1.45360005, 1, '2016-01-17 11:28:44');
...
(977, 0, 'config', 'config_error_filename', 'HTC_error.log', 0),
...
(972, 0, 'config', 'config_file_max_size', '900000', 0),
...
(963, 0, 'config', 'config_mail_alert', 'pedrocones@gmail.com', 0),
(962, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(961, 0, 'config', 'config_mail_smtp_port', '26', 0),
(960, 0, 'config', 'config_mail_smtp_password', 'Web867502!', 0),
(959, 0, 'config', 'config_mail_smtp_username', 'webmaster@hydrotools.com', 0),
(958, 0, 'config', 'config_mail_smtp_hostname', 'mail.hydrotools.com', 0),
(957, 0, 'config', 'config_mail_parameter', '-Fwebmaster@hydrotools.com', 0),
(954, 0, 'config', 'config_ftp_root', '', 0),
(955, 0, 'config', 'config_ftp_status', '0', 0),
(956, 0, 'config', 'config_mail_protocol', 'mail', 0),
(953, 0, 'config', 'config_ftp_password', '', 0),
(952, 0, 'config', 'config_ftp_username', '', 0),
(951, 0, 'config', 'config_ftp_port', '21', 0),
(950, 0, 'config', 'config_ftp_hostname', 'test', 0),
(948, 0, 'config', 'config_image_location_width', '268', 0),
(945, 0, 'config', 'config_image_wishlist_height', '47', 0),
(949, 0, 'config', 'config_image_location_height', '50', 0),
(947, 0, 'config', 'config_image_cart_height', '47', 0),
(946, 0, 'config', 'config_image_cart_width', '47', 0),
(944, 0, 'config', 'config_image_wishlist_width', '47', 0),
(943, 0, 'config', 'config_image_compare_height', '90', 0),
(942, 0, 'config', 'config_image_compare_width', '90', 0),
(940, 0, 'config', 'config_image_related_width', '80', 0),
(941, 0, 'config', 'config_image_related_height', '80', 0),
(939, 0, 'config', 'config_image_additional_height', '74', 0),
(938, 0, 'config', 'config_image_additional_width', '74', 0),
(937, 0, 'config', 'config_image_product_height', '228', 0),
(936, 0, 'config', 'config_image_product_width', '228', 0),
(935, 0, 'config', 'config_image_popup_height', '500', 0),
(934, 0, 'config', 'config_image_popup_width', '500', 0),
(933, 0, 'config', 'config_image_thumb_height', '228', 0),
(932, 0, 'config', 'config_image_thumb_width', '228', 0),
(929, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(930, 0, 'config', 'config_image_category_width', '80', 0),
(931, 0, 'config', 'config_image_category_height', '80', 0),
(928, 0, 'config', 'config_logo', 'catalog/HTC160x135.png', 0),
(927, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1),
(926, 0, 'config', 'config_captcha', '', 0),
(925, 0, 'config', 'config_return_status_id', '2', 0),
(924, 0, 'config', 'config_return_id', '0', 0),
(923, 0, 'config', 'config_affiliate_mail', '0', 0),
(922, 0, 'config', 'config_affiliate_id', '4', 0),
(921, 0, 'config', 'config_affiliate_commission', '5', 0),
(920, 0, 'config', 'config_affiliate_auto', '0', 0),
(919, 0, 'config', 'config_affiliate_approval', '0', 0),
(918, 0, 'config', 'config_stock_checkout', '0', 0),
(917, 0, 'config', 'config_stock_warning', '0', 0),
(916, 0, 'config', 'config_stock_display', '0', 0),
(915, 0, 'config', 'config_api_id', '1', 0),
(914, 0, 'config', 'config_order_mail', '1', 0),
(913, 0, 'config', 'config_fraud_status_id', '7', 0),
(912, 0, 'config', 'config_complete_status', '["5","3"]', 1),
(911, 0, 'config', 'config_processing_status', '["5","1","2","12","3"]', 1),
(910, 0, 'config', 'config_order_status_id', '1', 0),
(909, 0, 'config', 'config_checkout_id', '5', 0),
(908, 0, 'config', 'config_checkout_guest', '1', 0),
(907, 0, 'config', 'config_cart_weight', '1', 0),
(906, 0, 'config', 'config_invoice_prefix', 'HTC-2016-00', 0),
(905, 0, 'config', 'config_account_mail', '0', 0),
(904, 0, 'config', 'config_account_id', '3', 0),
(903, 0, 'config', 'config_login_attempts', '5', 0),
(902, 0, 'config', 'config_customer_price', '0', 0),
(901, 0, 'config', 'config_customer_group_display', '["1"]', 1),
(900, 0, 'config', 'config_customer_group_id', '1', 0),
(899, 0, 'config', 'config_customer_online', '0', 0),
(898, 0, 'config', 'config_tax_customer', 'shipping', 0),
(897, 0, 'config', 'config_tax_default', 'shipping', 0),
(896, 0, 'config', 'config_tax', '0', 0),
(895, 0, 'config', 'config_voucher_max', '1000', 0),
(894, 0, 'config', 'config_voucher_min', '1', 0),
(893, 0, 'config', 'config_review_mail', '1', 0),
(892, 0, 'config', 'config_review_guest', '0', 0),
(891, 0, 'config', 'config_review_status', '1', 0),
(890, 0, 'config', 'config_limit_admin', '20', 0),
(889, 0, 'config', 'config_product_description_length', '100', 0),
(888, 0, 'config', 'config_product_limit', '15', 0),
(887, 0, 'config', 'config_product_count', '1', 0),
(886, 0, 'config', 'config_weight_class_id', '1', 0),
(885, 0, 'config', 'config_length_class_id', '2', 0),
(884, 0, 'config', 'config_currency_auto', '1', 0),
(883, 0, 'config', 'config_currency', 'USD', 0),
(882, 0, 'config', 'config_admin_language', 'en-CA', 0),
(881, 0, 'config', 'config_language', 'en-CA', 0),
(880, 0, 'config', 'config_zone_id', '602', 0),
(878, 0, 'config', 'config_comment', 'We R - Rent Resell and Refurbish Heavy Duty Tools', 0),
(879, 0, 'config', 'config_country_id', '38', 0),
(877, 0, 'config', 'config_open', '08:00 - 17:00 UTC - 0700', 0),
(876, 0, 'config', 'config_image', 'catalog/HTC160x135.png', 0),
(875, 0, 'config', 'config_fax', '+1-425-790.6271', 0),
(874, 0, 'config', 'config_telephone', '+1-780-224.8873', 0),
(871, 0, 'config', 'config_address', 'Edmonton, Alberta Canada', 0),
(872, 0, 'config', 'config_geocode', '53.45, -113.47', 0),
(873, 0, 'config', 'config_email', 'webmaster@hydrotools.com', 0),
(870, 0, 'config', 'config_owner', 'Hydro Tools Corp', 0),
(869, 0, 'config', 'config_name', 'Hydro Tools Corp', 0),
(868, 0, 'config', 'config_layout_id', '4', 0),
(867, 0, 'config', 'config_template', 'default', 0),
(866, 0, 'config', 'config_meta_keyword', 'hydraulic, hydraulic tools, hydraulic components, cylinders, pumps, valves, controllers, lubricators, trico oilers, trico ', 0),
(865, 0, 'config', 'config_meta_description', 'We R - Rent Resell and Refurbish Heavy Duty Tools', 0),
(864, 0, 'config', 'config_meta_title', 'Hydro Tools Corp', 0);
