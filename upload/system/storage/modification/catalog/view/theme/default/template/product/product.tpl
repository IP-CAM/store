      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="nav nav-tabs">
            ...
            <?php } ?>
            <li><a href="#tab-askquestion" class="scroll" data-toggle="tab"><?php echo $tab_question; ?></a></li>
          </ul>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
            <?php if (!$special) { ?>
            <li>
              <h2><?php if ($zero_price <= 0) { ?><a onclick="$('a[href=\'#tab-askquestion\']').trigger('click'); return false;" style="text-decoration: none !important; cursor: pointer !important;"><img src="image/ask_for_price.png" align="absmiddle" /> <?php echo $text_zero_price; ?></a><?php } else { ?><?php echo $price; ?><?php } ?></h2>
            </li>
            <?php } else { ?>
          ...
          <div class="product-thumb transition">
            ...
            <div class="caption">
              ...
              <p class="price">
                ...
                <?php if ($product['zero_price'] <= 0) { ?><a href="<?php echo $product['href'] . '#tab-askquestion'; ?>" style="text-decoration: none !important;"><img src="image/ask_for_price.png" align="absmiddle" /> <?php echo $text_zero_price; ?></a><?php } else { ?><?php echo $product['price']; ?><?php } ?>
                <?php } else { ?>
                <span class="price-new"><?php echo $product['special']; ?></span> <span class="price-old"><?php echo $product['price']; ?></span>
                <?php } ?>
                <?php if (($product['tax']) && ($product['zero_price'] > 0)) { ?>
