...
$_['help_limit_admin']   	           = 'Determines how many admin items are shown per page (e.g. orders, customers).';
...
$_['help_invoice_prefix']              = 'Set the invoice prefix (e.g. INV-2014-00). Invoice IDs will start at 1 for each unique prefix.';
...
$_['help_mail_alert']                  = 'Any additional e-mails you want to receive the alert e-mail in addition to the main store e-mail. (Comma separated.)';
...
$_['help_file_max_size']		       = 'The maximum image file size you can upload in Image Manager. Enter as bytes.';
