<?php
class ControllerCaptcha2GoogleCaptcha extends Controller {
    public function index($error = array()) {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/captcha2/google_captcha.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/captcha2/google_captcha.tpl', $data);
		} else {
			return $this->load->view('default/template/captcha2/google_captcha.tpl', $data);
		}
    }
