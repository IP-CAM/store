...
$_['help_open']                        = 'Fill in your stores opening time.';
$_['help_comment']                     = 'This field is for any special notes you would like to tell the customer e.g. Store does not accept checks.';
...
$_['help_product_limit'] 	           = 'Determines how many catalog items are shown per page (e.g. products, categories)';
$_['help_product_description_length']  = 'In the list view, short description character limit (e.g. categories, specials)';
...
$_['error_store']                      = 'Warning: This Store cannot be deleted as it is currently assigned to %s order(s)!';