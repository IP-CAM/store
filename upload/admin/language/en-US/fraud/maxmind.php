...
$_['help_is_trans_proxy']                     = 'Whether IP address is in our database of known transparent proxy servers, returned if forwarded IP is passed as an input.';
...
$_['help_bin_phone_match']                    = 'Whether customer service phone number matches inputted BIN Phone. A return value of Yes provides a positive indication that cardholder is in possession of credit card.';
...
$_['help_city_postal_match']                  = 'Whether billing city and state match ZIP code. Currently available for US addresses only. Returns an empty string outside the US.';
$_['help_ship_city_postal_match']             = 'Whether shipping city and state match ZIP code. Currently available for US addresses only. Returns an empty string outside the US.';
$_['help_score']                              = 'The higher the score the more likely the order is fraudulent. Set a score between 0 - 100.';
