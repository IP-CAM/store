...
$_['text_import_description']		= 'Customize the status of an order during different stages. You cannot use a status on an eBay order that does not exist in this list.';
...
$_['text_payment_cheque']			= 'Check accepted';
...
$_['entry_import_cancelled_id']		= 'Canceled status:';
...
$_['help_timezone_offset']     		= 'Based on hours. 0 is UTC timezone. Only works if eBay time is used for order creation.';
