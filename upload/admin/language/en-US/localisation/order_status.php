...
$_['error_store']      = 'Warning: This order status cannot be deleted as it is currently assigned to %s store(s)!';
$_['error_order']      = 'Warning: This order status cannot be deleted as it is currently assigned to %s order(s)!';