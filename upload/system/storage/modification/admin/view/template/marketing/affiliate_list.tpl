  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-affiliate').attr('action', '<?php echo html_entity_decode($this->registry->get('url')->link('marketing/affiliate/delete', 'token=' . $token, 'SSL'), ENT_QUOTES, 'UTF-8'); ?>').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
