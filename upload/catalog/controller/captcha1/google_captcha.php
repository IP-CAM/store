<?php
class ControllerCaptcha1GoogleCaptcha extends Controller {
    public function index($error = array()) {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/captcha1/google_captcha.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/captcha1/google_captcha.tpl', $data);
		} else {
			return $this->load->view('default/template/captcha1/google_captcha.tpl', $data);
		}
    }
